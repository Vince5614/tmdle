    ...
    >
      ...
      >
        ...
        <div className="w-full flex flex-col gap-3">
          ...
          <button
            onClick={() => router.push(`/mapguessrold/practice?seed=${Math.floor(Math.random() * 100000)}`)}
...
export default function MapGuessr({ challenge, mode = "daily" }: {
  ...
  const shareText = [`MAPGUESSR — ${dateLabel}`, emojiGrid, phase === "won" ? `${score}/4 ⭐` : "0/4 ❌", "https://tmdle.com/mapguessrold"].join("\n");
